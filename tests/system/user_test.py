    ...
    def test_register_user(self):
        with self.app() as client:
            with self.app_context():
                ...
                # json.loads changes back to Python dictionary
    ...
    def test_register_and_login(self):
        with self.app() as client:
            with self.app_context():
                ...
                # Using auth endpoint requires json format, does not accept form format
                # json.dumps takes dictionary and dumps it as a string
